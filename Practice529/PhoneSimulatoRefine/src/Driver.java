public class Driver {
  ...
  public static void main(String[] args) {
    ...
    MessageGenerator messageGenerator1 = new MessageGenerator("Mother",aPhone);
    MessageGenerator messageGenerator2 = new MessageGenerator("Father",aPhone);
    messageGenerator1.start();
    messageGenerator2.start();
